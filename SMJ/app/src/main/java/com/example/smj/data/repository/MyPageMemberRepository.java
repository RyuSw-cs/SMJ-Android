...
public class MyPageMemberRepository {
    ...
    public MyPageMemberRepository() {
        this.entityMember = NetworkManager.getInstance().getRetrofit().create(Entity_Member.class);;
    }

    public void retrieveData(String key, MyPageMemberUseCase myPageMemberUseCase){
        ...
        call.enqueue(new Callback<List<MemberData>>() {
            ...
            public void onResponse(Call<List<MemberData>> call, Response<List<MemberData>> response) {
                if(response.isSuccessful()){
                    ...
                    myPageMemberUseCase.onDataSuccess(response.body());
                }
            }
    ...
    public void updateData(MemberPostData data, String key, int id, Context context, MyPageMemberUseCase myPageMemberUseCase){
