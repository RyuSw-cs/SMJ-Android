...
public class LivingTipCommentAdapter extends RecyclerView.Adapter<LivingTipCommentAdapter.ViewHolder> {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder{
        ...
        ViewHolder(View itemView){
            ...
            date = itemView.findViewById(R.id.living_tip_comment_date);
            commenter = itemView.findViewById(R.id.living_tip_commenter);
            contents = itemView.findViewById(R.id.living_tip_comment_contents);
        }
    }
    ...
    public LivingTipCommentAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = inflater.inflate(R.layout.activity_living_tip_comment_item,parent,false);
